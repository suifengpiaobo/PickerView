...
import com.zxl.pickerview.adapter.WheelAdapter;
...
/**
 * Description 3d滚轮
 * Created by zxl on 2017/1/3 下午2:52.
...
public class WheelView extends View{
    ...
    private String getContentText(Object item) {
        ...
        else if (item instanceof PickerViewPojo) {
            return ((PickerViewPojo) item).getPickerViewText();
        }
